" Based heavily on https://github.com/fxn/vim-monochrome
" License:    MIT
...
let g:colors_name = 'nvim-monochrome'
...
call s:hi('PmenuSel', s:bgray, s:dgray)
...
call s:hi('Special')
call s:hi('MatchParen', s:black, s:yellow, s:underline)
